...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="container mx-auto py-4 pt-20 px-6 md:px-20 lg_px-32 my-20 w-full overflow-hidden"
      id="Projects"
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">
        Crafting Spaced, Building Legacies-Explore Our Portfolio
      </p>
      ...
      <div className="flex justify-end items-center mb-8">
        <button
          onClick={prevProject}
          className="p-3 bg-gray-20 rounded mr-2"
