...
const Testimonails = () => {
  return (
    ...
    >
      <h1
        className=" text-2xl
       sm:text-4xl font-bold mb-2 text-center"
      >
        Customer{" "}
        <span className="underline underline-offset-4 duration-1 under font-light">
          Testimonials
        </span>
      </h1>
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {testimonialsData.map((testimonial, index) => (
          ...
          >
            <img
              className="w-20 h-20 rounded-full mx-auto md:-4"
